# Name: anagram
anagram - generates a full list of anagram sets of single words in a chosen (combination of) language(s). Three versions are available:
...
# Description:
anagram is a program generates a full list of anagram sets of single words in a chosen
